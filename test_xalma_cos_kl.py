...
model = AutoModelForCausalLM.from_pretrained(
    '/home/jihad.rbaiti/lustre/aim_neural-7he0p8agska/users/jihad.rbaiti/Work2_vf/Atlas_chat_2/XALMA_cos_kl/checkpoint-10000',
...
for i in range(len(test_data)):
    ...
    inputs = tokenizer([prompt1], return_tensors="pt", padding=True, max_length=512, truncation=True).to(device)
...
results.to_csv('/home/jihad.rbaiti/Work_2/CPO/CPO_atlas/Predictions/xalma_cos_kl_2.csv', index=False)
