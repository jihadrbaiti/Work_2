...
print('test of NLLB/xalma_rbf')
# Load model and tokenizer
model = AutoModelForSeq2SeqLM.from_pretrained(
    '/localssd/chouaib/geo_ai/Model_NLLB/XALMA_rbf/checkpoint-10000',
...
ref = []
src = []
output_file = '/localssd/chouaib/geo_ai/Work_2/Predictions/NLLB/nllb_xalma_rbf.csv'
