...
print('test of xalma_cos')
# Load model and tokenizer
model = AutoModelForSeq2SeqLM.from_pretrained(
    '/home/jihad.rbaiti/lustre/aim_neural-7he0p8agska/users/jihad.rbaiti/Work2_vf/NLLB/XALMA_cos/checkpoint-10000',
...
ref = []
src = []
output_file = '/home/jihad.rbaiti/Work_2/CPO/CPO_nllb/Predictions/xalma_cos.csv'
