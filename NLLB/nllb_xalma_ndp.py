...
from ALMA1.utils.cpo_trainer_ndp import CPOTrainer
...
print(device)
print('Training script of XALMA_ndp')
...
#wandb.init(id='bx4ip03h', resume='must', project="huggingface", name="NLLB_XALMA_ndp" )
wandb.login(key='86570a60523435fb4d496c0e63e8ae11c308bae2')
cpo_config = CPOConfig(
    output_dir='/localssd/chouaib/geo_ai/Model_NLLB/XALMA_ndp/XALMA_ndp',
    max_steps=10000,
    eval_strategy="epoch",
    ...
    max_length=200,
    max_prompt_length=256,logging_dir="/localssd/chouaib/geo_ai/Model_NLLB/XALMA_ndp/XALMA_ndp/logs")
...
#trainer.train(resume_from_checkpoint="/home/jihad.rbaiti/lustre/aim_neural-7he0p8agska/users/jihad.rbaiti/Work2_vf/NLLB/XALMA_ndp/checkpoint-6500")
trainer.train()
