...
wandb.init(project="huggingface", name="ATLAS_SFTp", config={"logging_first_step": True}, mode="online")
...
model_path = f"/home/jihad.rbaiti/lustre/pt_cloud-muhqxqc6fxo/users/jihad.rbaiti/Work_2/Atlas_chat/SFTp/model_checkpoint_step_{total_steps}/"
os.makedirs(checkpoint_path, exist_ok=True)
