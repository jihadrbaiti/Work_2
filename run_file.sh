...
CUDA_VISIBLE_DEVICES=1,2,3,4 accelerate launch --main_process_port=29515 --num_processes=4 cpo_atlas_ndp.py \
...
CUDA_VISIBLE_DEVICES=1,2,3,4 accelerate launch --main_process_port=29516 --num_processes=4 cpo_atlas_rbf.py \
