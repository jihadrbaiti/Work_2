...
from trl import ModelConfig, get_peft_config  # No need to import unused ones
from ALMA1.utils.cpo_trainer_xalma import CPOTrainer
...
#wandb.init(id='spjkbxt3', resume='must', project="huggingface", name="ATLAS_XALMA_correct" )
wandb.login(key='86570a60523435fb4d496c0e63e8ae11c308bae2')
print('This script is the training script of XALMA using ATLAS-CHAT')
...
# Preprocessing function using model's chat formatting logic
def process(row):
    try:
