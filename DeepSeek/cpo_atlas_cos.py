...
'''config = AutoConfig.from_pretrained("NousResearch/Llama-2-7b-chat-hf", trust_remote_code=True)
...
base_model = AutoModelForCausalLM.from_pretrained("NousResearch/Llama-2-7b-chat-hf", torch_dtype=torch.bfloat16,  trust_remote_code=True)
...
cpo_config = CPOConfig(
    ...
    logging_dir="/localssd/chouaib/geo_ai/Model2/DeepSeek/XALMA_cos/logs")
