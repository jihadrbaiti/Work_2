...
print('Test script for prediction of XALMA_attention_atlas training model')
test_data = pd.read_csv('/localssd/chouaib/geo_ai/Work_2/data/parallel_dataset/final_data_splitting/test.csv')

# Load model and tokenizer
model = AutoModelForCausalLM.from_pretrained(
    '/localssd/chouaib/geo_ai/Model2/XALMA_attention/checkpoint-10000',
...
results.to_csv('/localssd/chouaib/geo_ai/Work_2/Predictions/Atlas-chat/xalma_attention_2.csv', index=False)
